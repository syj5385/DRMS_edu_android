...
public class Cont1_2_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cont1_2);
        ...
        vel1 = (ImageView)findViewById(R.id.vel1);
        vel1.setOnTouchListener(mTouchListener);

        vel2 = (ImageView)findViewById(R.id.vel2);
        vel2.setOnTouchListener(mTouchListener);

        vel3 = (ImageView)findViewById(R.id.vel3);
        vel3.setOnTouchListener(mTouchListener);

        vel4 = (ImageView)findViewById(R.id.vel4);
        vel4.setOnTouchListener(mTouchListener);
            ...
            switch (v.getId()) {
                ...
                case R.id.upload:
                    if(event.getAction() == MotionEvent.ACTION_DOWN) {
                        ...
                        intent.putExtra("Firmware","L1R2");
                        startActivity(intent);
//                        Thread mThread = new FiledownThread();
//                        mThread.start();
//                        try{
//                            Thread.sleep(1000);
//                        }catch(InterruptedException e){
//                            Log.d("file down load waiting","Interrupted Exception",e);
//                        }
//
//                        if (getPackageList()) {
//                            Intent intent = getPackageManager().getLaunchIntentForPackage("io.iotool.iotoolarduinohex");
//                            startActivity(intent);
//                            file_state = false;
//                        } else if (!getPackageList()) {
//                            String url = "market://details?id=" + "io.iotool.iotoolarduinohex";
...
//                        }
    ...
    public class FiledownThread extends Thread{
        ...
        public void run() {
            try {
                InputStream is = getResources().openRawResource(R.raw.r1_2);

                File file = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)+"/drs1_2_firmware.hex");
