...
//                    timer.setText(String.valueOf(RCsignal[0]));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog2 = new AlertDialog.Builder(ACCJoystick.this);


//                        dialog2.setCustomTitle(title_layout2);
        dialog2.setView(R.layout.tream_dialog_acc);
...
//                }
    ...
    public void roll_up_acc_Click(View v){
        tream[0] += 3;
        RCsignal[0] += 3;

    }

    public void roll_down_acc_Click(View v){
        tream[0] -= 3;
        RCsignal[0] -= 3;

    }

    public void pitch_up_acc_Click(View v){
//        Toast.makeText(getApplicationContext(),"PITCH_UP",Toast.LENGTH_SHORT).show();
        tream[1] += 3;
        RCsignal[1] += 3;
    }

    public void pitch_down_acc_Click(View v){
        tream[1] -= 3;
        RCsignal[1] -= 3;

    }

    public void yaw_up_acc_Click(View v){
//        Toast.makeText(getApplicationContext(),"YAW_UP",Toast.LENGTH_SHORT).show();
    ...
    public void yaw_down_acc_Click(View v){
