...
//                            Toast.makeText(getApplicationContext(), "연결중....", Toast.LENGTH_LONG).show();
                ...
                case UPLOAD_STATE :
                    switch(msg.arg1){
                        case 1:
//                            Toast.makeText(getApplicationContext(),"드론 펌웨어 설정 중입니다.\n 잠시만 기다려 주세요.",Toast.LENGTH_SHORT).show();
...
//                                mHandler.obtainMessage(UPLOAD_STATE, -1, -1).sendToTarget();
    ...
    private String makeHexStringFromHexFile(String upload_file){
        ...
        if(upload_file.equals("L1R2")){
            inputStream = getResources().openRawResource(R.raw.r1_2);
            Toast.makeText(getApplicationContext(),upload_file,Toast.LENGTH_SHORT).show();
        }

        if(upload_file.equals("L1R3")){
            inputStream = getResources().openRawResource(R.raw.r1_3);
            Toast.makeText(getApplicationContext(),upload_file,Toast.LENGTH_SHORT).show();
        }

        if(upload_file.equals("L1R4")){
            inputStream = getResources().openRawResource(R.raw.r1_4);
            Toast.makeText(getApplicationContext(),upload_file,Toast.LENGTH_SHORT).show();
        }

        if(upload_file.equals("L1R5")){
            inputStream = getResources().openRawResource(R.raw.r1_5);
            Toast.makeText(getApplicationContext(),upload_file,Toast.LENGTH_SHORT).show();
        }

        if(upload_file.equals("L1R6")){
            inputStream = getResources().openRawResource(R.raw.r1_6);
            Toast.makeText(getApplicationContext(),upload_file,Toast.LENGTH_SHORT).show();
        }

        if(upload_file.equals("L1R7")){
            inputStream = getResources().openRawResource(R.raw.r1_7);
            Toast.makeText(getApplicationContext(),upload_file,Toast.LENGTH_SHORT).show();
        }
        if(upload_file.equals("L1R8")){
            inputStream = getResources().openRawResource(R.raw.r1_8);
            Toast.makeText(getApplicationContext(),upload_file,Toast.LENGTH_SHORT).show();
        }

        if(upload_file.equals("L1R9")){
            inputStream = getResources().openRawResource(R.raw.r1_9);
            Toast.makeText(getApplicationContext(),upload_file,Toast.LENGTH_SHORT).show();
        }

        if(upload_file.equals("L1_1_R1")){
            inputStream = getResources().openRawResource(R.raw.lev1_1_r1);
            Toast.makeText(getApplicationContext(),upload_file,Toast.LENGTH_SHORT).show();
        }

        if(upload_file.equals("L1_1_R2")){
            inputStream = getResources().openRawResource(R.raw.lev1_1_r2);
            Toast.makeText(getApplicationContext(),upload_file,Toast.LENGTH_SHORT).show();
        }

        if(upload_file.equals("L1_1_R3")){
            inputStream = getResources().openRawResource(R.raw.lev1_1_r3);
            Toast.makeText(getApplicationContext(),upload_file,Toast.LENGTH_SHORT).show();
        }

        if(upload_file.equals("L2R2")){
            inputStream = getResources().openRawResource(R.raw.lev2_r2);
            Toast.makeText(getApplicationContext(),upload_file,Toast.LENGTH_SHORT).show();
        }

        if(upload_file.equals("L2R3")){
            inputStream = getResources().openRawResource(R.raw.lev2_r3);
            Toast.makeText(getApplicationContext(),upload_file,Toast.LENGTH_SHORT).show();
        }

        if(upload_file.equals("L2R4")){
            inputStream = getResources().openRawResource(R.raw.lev2_r4);
            Toast.makeText(getApplicationContext(),upload_file,Toast.LENGTH_SHORT).show();
        }

        if(upload_file.equals("L2R5")){
            inputStream = getResources().openRawResource(R.raw.lev2_r5);
            Toast.makeText(getApplicationContext(),upload_file,Toast.LENGTH_SHORT).show();
        }

        if(upload_file.equals("L2R6")){
            inputStream = getResources().openRawResource(R.raw.lev2_r6);
            Toast.makeText(getApplicationContext(),upload_file,Toast.LENGTH_SHORT).show();
        }

        if(upload_file.equals("L2R8")){
            inputStream = getResources().openRawResource(R.raw.lev2_r8);
            Toast.makeText(getApplicationContext(),upload_file,Toast.LENGTH_SHORT).show();
        }

        if(upload_file.equals("L2R9")){
            inputStream = getResources().openRawResource(R.raw.lev2_r9);
            Toast.makeText(getApplicationContext(),upload_file,Toast.LENGTH_SHORT).show();
        }

        if(upload_file.equals("L2R10")){
            inputStream = getResources().openRawResource(R.raw.lev2_r10);
            Toast.makeText(getApplicationContext(),upload_file,Toast.LENGTH_SHORT).show();
        }

        if(upload_file.equals("L2R11")){
            inputStream = getResources().openRawResource(R.raw.lev2_r11);
            Toast.makeText(getApplicationContext(),upload_file,Toast.LENGTH_SHORT).show();
        }
