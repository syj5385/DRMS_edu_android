...
import com.drms.drmakersystem.Communication.Protocol.STK500v1.ConstantsStk500v1;
...
public class BluetoothService {
    ...
    public static final int DRS_PROTOCOL = 101;
    public static final int Multiwii_PROTOCOL = 102;
    public static final int STK_PROTOCOL = 103;
