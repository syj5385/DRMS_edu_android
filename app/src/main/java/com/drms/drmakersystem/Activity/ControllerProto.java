...
public class ControllerProto extends ControllerActivity {
    ...
    protected void initializeView() {
        ...
        controller_layout = (LinearLayout) View.inflate(ControllerProto.this, R.layout.activity_cont_2_7,null);
        ...
        upload_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                UploadManager manager =
                        new UploadManager(ControllerProto.this, mBluetoothService, new FileManagement(ControllerProto.this).readBTAddress()[1], DRMS.LEV2_7){
